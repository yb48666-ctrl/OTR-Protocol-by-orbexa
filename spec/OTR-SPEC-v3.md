...
**Scoring model:**
- VERIFIED status (audit passed): 90 points
...
3. **Identity-Gameable Gap:** Identity score < 20 while average gameable dimension score > 70, with no established Tranco or Wikidata presence.
4. **Template Policy Detection:** Policy pages generated by known template services (Termly, TermsFeed, iubenda, etc.) combined with a young domain (< 12 months) and no established identity signals.
...
| Identity-Gameable Gap    | ×0.7      |
| Template Policy Detected | ×0.5      |
